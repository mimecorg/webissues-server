...
class System_Api_IssueManager extends System_Api_Base
{
    ...
    */
    public function getFile( $fileId, $flags = 0 )
    {
        ...
        $query = 'SELECT fl.file_id, fl.file_name, fl.file_descr, fl.file_storage, i.issue_id, i.folder_id, sc.user_id,';
        $query .= $principal->isAdministrator() ? ' %3d AS project_access' : ' r.project_access';
        ...
        if ( !( $file = $this->connection->queryRow( $query, $fileId, $principal->getUserId(), System_Const::AdministratorAccess ) ) )
