...
class Admin_Types_AddType extends System_Web_Component
{
    ...
    private function submit()
    {
        ...
        try {
            $typeManager->addIssueType( $this->typeName );
...
System_Bootstrap::run( 'Common_Application', 'Admin_Types_AddType' );
